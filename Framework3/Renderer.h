...
public:
	...
	virtual ShaderID addShader(const char *vsText, const char *gsText, const char *fsText, const char *csText, const int vsLine, const int gsLine, const int fsLine, const int csLine,
	...
	virtual bool updateVertexBuffer(VertexBufferID vb, const long size, const void* data) { return false; }
